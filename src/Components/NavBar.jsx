...
const NavBar = () => {
    ...
    <div className='lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-800 transition mt-10'>
      <ul className='text-center text-xl p-20'>
        <Link spy={true} smooth = {true} to="GMF">
          <li className='py-4 border-b border-amber-500 hover:bg-yellow-600 hover:rounded'> GMF </li>
        </Link>
  ...
  <div className="font-bold text-5xl text-amber-400 text-center">GMF</div>
