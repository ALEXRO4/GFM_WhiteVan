    ...
    <div>
      <div className='cajaE'>
              <div className='cajaIz'>
                <div className='fotoU'>
                  <img src="/Images/especs/toyotaLateral.jpeg" alt="foto1" className='rounded-lg' />
                </div>
                <div className='Imgs'>
              ...
              <div className='cajaDer'>
                <h2 className='font-bold text-4xl border-b-2 py-2 mx-6 text-center'>Camioneta Toyota</h2>
                ...
                <strong className='text-amber-500'> ventilación eficiente</strong>, lo que asegura confort durante largos trayectos. Su suspensión está diseñada para adaptarse a
                 caminos irregulares, mientras que el <strong className='text-amber-500'>motor potente</strong> y <strong className='text-amber-500'>eficiente</strong> ofrece 
                 un buen rendimiento tanto en rutas urbanas como en terrenos más difíciles. Es la opción ideal para quienes buscan un vehículo <strong className='text-amber-500'>
                  confiable</strong> y <strong className='text-amber-500'>cómodo</strong> para viajes y aventuras.
                </div>
